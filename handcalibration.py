...
cv2.createTrackbar('HighH', 'Calibration',0,255,nothing)
cv2.createTrackbar('HighS', 'Calibration',0,255,nothing)
cv2.createTrackbar('HighV', 'Calibration',0,255,nothing)
...
while True:
	...
	fontScale = 2
	thickness = 3
	putText(frame, text, textOrg, fontFace, fontScale, all(255), thickness, 8)
	...
	highh = cv2.getTrackbarPos('HighH', 'Calibration')
	highs = cv2.getTrackbarPos('HighS', 'Calibration')
	highv = cv2.getTrackbarPos('HighV', 'Calibration')
